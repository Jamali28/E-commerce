    ...
    return (
        <div>
                ...
                <div className="w-[1305px] h-[781px] top-[200px] gap-[129px] flex">
                    <div className="w-[805px] h-[781px] topright-4 bottomright-4 ">
                        <div className="w-[919px] h-[706px] top-[75px] left-[-8px]">
                            <Image className="pt-[14px] pl-[9px] " src={"/phone.jpg"} alt="" width={1720} height={1520} />
                        </div>


                        {/* login */}
                    </div>
                    <div className="w-[371px] h-[530px] gap-[48px]  m-12">
          ...
          gap-[8px]">
                            ...
                            <div className="w-[371px] h-[56px] rounded-[4px] m-1 border border-black border-spacing-1 pt-[16px] pr-[88px] pb-[16px] pl-[88px] gab-[10px] ">
                                <div className="w-[199px] h-[24] gap-[16px] flex">
                                    <Image className="pt-[14px] pl-[9px] " src={"/google.png"} alt="" width={34} height={22} />
                                    <p className="w-[159px] h-[34px] leading-[24px] text-[16px]">Sign up with Google</p>


                                </div>
                                <div className="w-[248px] h-[28px] gap-[16px]  m-5  flex">
                                    <div className="w-[185px] h-[24px] "><p className="leading-[24px] text-[16px]">Already have account?</p></div>
                                    <div className="w-[47px] h-[28px] gap-[4px]"> <p className="h-[24px] leading-[24px]  underline text-[16px]">
